...
path_CVE_fixes_libtiff = r'D:\pycharm\projects\CapstoneMS\datasetsNew\libtiff2\CVE_fix\**\**\*.c'
path_CVE_flaws_libtiff = r'D:\pycharm\projects\CapstoneMS\datasetsNew\libtiff2\CVE_flawed\**\**\*.c'

doc1 = pd.concat((pd.read_csv(f,sep='delimiter',engine='python') for f in glob.iglob(path_CVE_fixes_libtiff, recursive=True)), ignore_index=True)
doc2 = pd.concat((pd.read_csv(f,sep='delimiter',engine='python') for f in glob.iglob(path_CVE_flaws_libtiff, recursive=True)), ignore_index=True)
...
pp_doc1 = apply_pre_processing(doc5)
pp_doc2 = apply_pre_processing(doc6)
